...
Se encontrou um bug no SME-SIGPAE você pode reportá-lo usando a ferramenta de [issues do GitHub](https://github.com/prefeiturasp/SME-SIGPAE-API/issues). Porém antes de enviar seu bug é importante fazer as seguintes verificações:
