...
Se encontrou um bug no SME-Terceirizadas você pode reportá-lo usando a ferramenta de [issues do GitHub](https://github.com/prefeiturasp/SME-Terceirizadas/issues). Porém antes de enviar seu bug é importante fazer as seguintes verificações:
